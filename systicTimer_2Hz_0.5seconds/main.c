...
volatile bool changer = 0UL;


#define LED_BIT0 (changer << 0UL)
#define LED_BIT1 (changer << 1UL)
#define LED_BIT2 (changer << 2UL)
#define LED_BIT3 (changer << 3UL)
#define LED_BIT4 (changer << 4UL)
...
int main(void)
{
    ...
    // Configure systick
    NVIC_ST_RELOAD_R = 8000000-1; // reloading with the number of clock per seconds
