...
void Timer1A_Init(void)
{
    ...
    TIMER1_TAPR_R = 250; // this divides the system clock (16,000,000) by 250 = 64,000

    // Load the value into the TimerA
    TIMER1_TAILR_R = 64000; // This divides the remaining 64,000 by the given TAILR value (64,000)
...
// Set up Timer2A to 10Hz
void Timer2A_Init(void)
{
    // Enable TIMER2 Clock
    SYSCTL_RCGCTIMER_R |= SYSCTL_RCGCTIMER_R2;

    // Wait until the TIMER2 clock is ready
    ...
    // Set the TimerA to be in a periodic mode and down counter (10Hz)
    TIMER2_TAMR_R = TIMER_TAMR_TAMR_PERIOD;

    TIMER2_TAPR_R = 250; // this divides the system clock (16,000,000) by 250 = 64,000

    // Load the value into TimerA (divides remaining 64,000 by TAILR value)
    TIMER2_TAILR_R = 6400; // This divides the remaining 64,000 by the given TAILR value (6400) to achieve 10Hz
...
void TIMER1A_Handler(void)
{
    ...
    {
        // Toggle GPIO pin PF4
        GPIO_PORTF_AHB_DATA_R ^= 0x1UL << 4UL;
        delay(1);
    }
...
void TIMER2A_Handler(void)
{
    ...
    {
        // Toggle GPIO pin PF0
        GPIO_PORTF_AHB_DATA_R ^= 0x1UL << 0UL;
        delay(1);
    }

    // Clear the Timer2A interrupt flag
    TIMER2_ICR_R = TIMER_ICR_TATOCINT;
}
...
int main(void)
{
    ...
    // Set portF pin 4 AND O as an output pin
